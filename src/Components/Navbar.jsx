...
const Navbar = ({ onMenuClick }) => {
  ...
  return (
    <div
      className={`w-full px-4 md:px-6 py-4 flex justify-between items-center border-b
      ${
        theme === "dark"
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <button
          onClick={onMenuClick}
          className="lg:hidden p-1.5 rounded-md bg-gray-700 text-white"
        >
          ☰
        </button>
      ...
      <div className="flex gap-2 md:gap-4 items-center">
        <button
          ...
          className="px-2 md:px-3 py-1 rounded bg-blue-500 text-white text-sm"
        >
        ...
        <select
          ...
          className={`px-2 md:px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200
            ${
              theme === "dark"
